...
namespace md::Integrator {
    ...
    void RungeKutta::simulation_step(const double dt) {
        ...
        for (size_t i = 0; i < particles.size(); i++) {
            ...
            SPDLOG_TRACE("Updated position: [{},{},{}]", particles[i].position[0], particles[i].position[1],
                         particles[i].position[2]);
            SPDLOG_TRACE("Updated velocity: [{},{},{}]", particles[i].velocity[0], particles[i].velocity[1],
                         particles[i].velocity[2]);
            SPDLOG_TRACE("Updated force: [{},{},{}]", particles[i].force[0], particles[i].force[1],
                         particles[i].force[2]);
        }
    }
